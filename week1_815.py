...
Original file is located at
    https://colab.research.google.com/drive/1YxIlplKOm_kyYVgcOvVGKd0nOAc48zg1
"""
...
if __name__ == "__main__":
    ...
    for i in range(0,N):
        ...
        myx.append(A)
        txt.append(B)
    file1.writelines(txt) # Writes the data into a text file
    file1.close()
    file1 = open('test.txt', 'r') # Opens up a text file
    trufile = file1.read().split('\n') # Split the data into a readable format for the program
    for i in range(0,N): # Add the data from the text file to an array
        C = np.float64(trufile[i])
        tru.append(C)
    file1.close()
    # create histogram of our data
    n, bins, patches = plt.hist(tru, 50, density=True, facecolor='g', alpha=0.75)
